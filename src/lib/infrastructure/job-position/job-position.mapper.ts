import type { JobPositionModel, CreateJobPositionInput, UpdateJobPositionInput, JobPositionParams, JobPositionStatus } from '$lib/core/job-position';
import type { JobPositionResponse, JobPositionQuery, CreateJobPositionRequest, UpdateJobPositionRequest } from './job-position.schema';
