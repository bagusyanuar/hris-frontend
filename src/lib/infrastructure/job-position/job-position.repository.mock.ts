...
const mockData: JobPositionModel[] = [
    {
        id: '1',
        name: 'Engineering Manager', departmentId: 'dept-1', departmentName: 'Engineering', jobTitleId: 'jt-1', jobTitleName: 'Manager', parentId: null, headcountQuota: 1, status: 'active'
    },
    {
        id: '2',
        name: 'Frontend Developer', departmentId: 'dept-1', departmentName: 'Engineering', jobTitleId: 'jt-2', jobTitleName: 'Staff', parentId: '1', parentName: 'Engineering Manager', headcountQuota: 5, status: 'active'
    }
];
