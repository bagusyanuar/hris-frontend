...
<Story name="Default">
	<div class="h-[600px] flex bg-slate-100 dark:bg-slate-950 p-4 gap-4">
		...
		<div class="flex-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6">
			<button
			...
			<p class="mt-4 text-sm text-slate-500">Active Menu: <strong class="text-slate-900 dark:text-slate-100">{activeMenu}</strong></p>
		</div>
	</div>
</Story>
