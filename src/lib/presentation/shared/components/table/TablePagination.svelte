...
{#if table}
  ...
  >
    ...
    <div class="flex items-center gap-1">
      <Typography variant="body-sm" color="secondary">Menampilkan</Typography>
      <Typography variant="body-sm" weight="semibold">
        {startIdx}-{endIdx}
      </Typography>
      <Typography variant="body-sm" color="secondary">dari</Typography>
      <Typography variant="body-sm" weight="semibold">
        {totalRows}
      </Typography>
      <Typography variant="body-sm" color="secondary">data</Typography>
    </div>
    ...
    <div class="flex flex-wrap items-center gap-6">
      ...
      <div class="flex items-center gap-2">
        <Typography variant="body-sm" color="secondary">Baris per halaman:</Typography>
        <div class="relative">
          <select
            value={pageSize}
