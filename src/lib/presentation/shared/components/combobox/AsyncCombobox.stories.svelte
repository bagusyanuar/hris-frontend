...
<Story name="Single Select">
	<div class="max-w-sm space-y-4">
		...
		/>
		<p class="text-sm text-slate-500">Selected: <strong class="text-slate-900">{selectedDoctor ? JSON.stringify(selectedDoctor) : 'None'}</strong></p>
	</div>
</Story>
...
<Story name="Multiple Select">
	<div class="max-w-sm space-y-4">
		...
		/>
		<p class="text-sm text-slate-500">Selected: <strong class="text-slate-900">{selectedDoctors ? JSON.stringify(selectedDoctors) : 'None'}</strong></p>
	</div>
</Story>
