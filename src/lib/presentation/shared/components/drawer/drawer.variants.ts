...
export const drawerContentVariants = cva(
  'fixed z-50 flex flex-col bg-white dark:bg-slate-900 shadow-xl transition-transform duration-300 ease-in-out',
  {
    variants: {
      position: {
        right:
          'inset-y-0 right-0 w-full sm:w-[400px] md:w-[500px] border-l border-slate-200 dark:border-slate-800',
...
export const drawerHeaderClass =
  'flex items-center justify-between border-b border-slate-200 dark:border-slate-800 p-4 sm:p-6';
