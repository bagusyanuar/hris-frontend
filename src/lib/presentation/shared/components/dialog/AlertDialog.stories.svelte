...
<Story name="Danger / Destructive (Async)">
  <div class="p-6">
    <Button onclick={() => (isDangerOpen = true)} variant="danger">Open Danger Alert</Button>
...
<Story name="Info Alert">
  <div class="p-6">
    <Button onclick={() => (isInfoOpen = true)} variant="outline">Open Info Alert</Button>
...
<Story name="Success Alert">
  <div class="p-6">
    <Button onclick={() => (isSuccessOpen = true)}>Open Success Alert</Button>
...
<Story name="Custom Actions (3 Buttons)">
  <div class="p-6">
    ...
    <AlertDialog bind:open={isCustomActionsOpen} title="Save Changes to Report?" variant="warning">
      <p>
        You are closing the monthly performance report. What would you like to do with your draft?
      </p>

      {#snippet actions()}
        <div class="flex justify-between w-full items-center gap-3">
          <Button variant="ghost" onclick={() => (isCustomActionsOpen = false)}>Cancel</Button>
          <div class="flex gap-2">
            <Button variant="outline" onclick={() => (isCustomActionsOpen = false)}>Discard</Button>
