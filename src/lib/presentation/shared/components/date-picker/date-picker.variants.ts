...
export const datePickerTriggerVariants = cva(
  'flex w-full items-center justify-between rounded-lg border bg-neutral-card text-slate-900 transition-colors duration-200 focus:outline-none focus:ring-0 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-500 dark:bg-slate-900 dark:text-slate-100 dark:disabled:bg-slate-800',
  {
    variants: {
      variant: {
        default:
