...
<Story name="Default">
  <div class="max-w-sm space-y-4">
    ...
    <p class="text-sm text-slate-500">
      Selected Value: <strong class="text-slate-900"
        >{selectedDate ? selectedDate.toString() : 'None'}</strong
      >
    </p>
  </div>
</Story>
...
<Story name="Empty / Placeholder">
  <div class="max-w-sm space-y-4">
    <DatePicker bind:value={emptyDate} label="Target Date" placeholder="Pilih tanggal target..." />
  </div>
</Story>
...
<Story name="Disabled">
  <div class="max-w-sm">
    <DatePicker value={today(getLocalTimeZone())} disabled label="Disabled Date Picker" />
  </div>
</Story>
...
<Story name="Popover Alignments">
  <div class="max-w-sm space-y-6">
    <DatePicker align="start" label="Align Start (Default / Rata Kiri)" />
    <DatePicker align="center" label="Align Center (Rata Tengah)" />
    <DatePicker align="end" label="Align End (Rata Kanan)" />
  </div>
</Story>
...
<Story name="Month Picker Mode">
  <div class="max-w-sm space-y-4">
    ...
    <p class="text-sm text-slate-500">
      Selected Value: <strong class="text-slate-900"
        >{monthValue ? monthValue.toString() : 'None'}</strong
      >
    </p>
  </div>
</Story>
...
<Story name="Year Picker Mode">
  <div class="max-w-sm space-y-4">
    ...
    <p class="text-sm text-slate-500">
      Selected Value: <strong class="text-slate-900"
        >{yearValue ? yearValue.toString() : 'None'}</strong
      >
    </p>
  </div>
</Story>
