...
<Story
  name="Success State"
  args={{ label: 'Username', variant: 'success', helperText: 'Username is available!' }}
/>

<Story name="Disabled" args={{ label: 'Employee ID', disabled: true, value: 'EMP-2026-001' }} />

{#snippet prefixSearch()}
  <Icon icon="lucide:search" class="w-5 h-5" />
{/snippet}

{#snippet suffixAmount()}
...
<Story
  ...
  args={{ label: 'Search', placeholder: 'Search...', prefix: prefixSearch }}
/>

<Story
  name="With Icon Suffix"
  args={{ label: 'Amount', placeholder: '0.00', suffix: suffixAmount }}
/>
