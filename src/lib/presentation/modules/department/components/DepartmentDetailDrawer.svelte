...
<Drawer {isOpen} {onClose} position="right">
  ...
  {#if department}
    <div class="flex flex-col gap-6">
      ...
      <!-- Manager Info -->
      <div>
        <Typography variant="h6" weight="semibold" class="mb-3" color="brand"
          >Kepala Departemen</Typography
        >
      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-3">
          <div
            class="rounded-xl border border-slate-200 dark:border-slate-800 p-3 flex flex-col justify-center"
          >
      ...
      {#if department.children && department.children.length > 0}
        ...
        <div>
          <Typography variant="h6" weight="semibold" class="mb-3" color="brand"
            >Daftar Sub-departemen</Typography
          >
